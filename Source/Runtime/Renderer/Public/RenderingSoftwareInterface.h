...
{
	VertexData() { }
	VertexData(Vector4 InPosition) : Position(InPosition) {}
	Vector4 Position;
...
public:
	...
	virtual void DrawLine2(const ScreenPoint& InStartPos, const ScreenPoint& InEndPos, const LinearColor& InColor) = 0;
