...
void TriangleRasterizer::RecalcBounds()
{
	...
	UVector = VertexBuffer[1].Position.ToVector2() - VertexBuffer[0].Position.ToVector2();
	VVector = VertexBuffer[2].Position.ToVector2() - VertexBuffer[0].Position.ToVector2();
